...
public :
    ...
    QHash<QString, medAbstractParameterGroupL*> currentGroups;
...
void medLinkMenu::addGroup(medAbstractParameterGroupL * group, bool selected)
{
...
void medLinkMenu::setGroups(QList<medAbstractParameterGroupL*> groups)
{
