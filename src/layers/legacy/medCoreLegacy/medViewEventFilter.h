...
protected:
    ...
    virtual bool mouseWheelEvent( medAbstractView *view, QMouseEvent * mouseEvent );
    ...
    virtual bool mouseWheelEvent( medAbstractView *view, QGraphicsSceneMouseEvent *mouseEvent );
