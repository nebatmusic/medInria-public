function(music_plugins_liryc_project)
    ...
    if (USE_${external_project})
        ...
        if (NOT USE_SYSTEM_${external_project})
            ...
            set(git_url ${GITHUB_PREFIX}FBU-IHU-LIRYC/music-private.git)
            set(git_tag music3)

            set(${external_project}_BUILD_TYPE RelWithDebInfo CACHE STRING "Build type for Liryc plugins: None Debug Release RelWithDebInfo MinSizeRel")
