...
if (WIN32)
  ...
  ExternalProject_Add(${ep}
    ...
    CONFIGURE_COMMAND perl ${EP_PATH_SOURCE}/${ep}/Configure VC_WIN64A  no-zlib no-shared --prefix=${build_path}  --openssldir=${build_path} 
  ...
  ExternalProject_Add(${ep}
    ...
    PATCH_COMMAND ""
    DEPENDS ${${ep}_dependencies}
    CONFIGURE_COMMAND ${EP_PATH_SOURCE}/${ep}/config no-zlib no-shared --prefix=${build_path} --openssldir=${build_path} 
